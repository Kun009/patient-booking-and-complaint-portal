...
<script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                const checkNicUrl = 'check_pnic.php?nic=' + encodeURIComponent(nicValue);
...
<td class="label-td" colspan="2">
    ...
    <input type="date" name="dob" class="input-text" placeholder="Date of Birth" value="'.$dob.'" required><br>
                                ...
                                <tr>
                                       <td class="label-td" colspan="2">
    <input type="address" name="address" class="input-text" placeholder="Addresss"  value="'.$address.'" required><br>
</td>
