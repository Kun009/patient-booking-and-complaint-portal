...
<script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                const checkNicUrl = 'check_nic.php?nic=' + encodeURIComponent(nicValue);
...
<td class="menu-btn menu-icon-doctor  ">
                        <a href="admin.php" class="non-style-link-menu non-style-link-menu"><div><p class="menu-text">Admins</p></a></div>
                    </td>
                    </tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="Tele" class="input-text" placeholder="Telephone Number" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                       <td class="label-td" colspan="2">
    <input type="tel" name="Tele" class="input-text" placeholder="Telephone Number" pattern="[0-9]+" value="'.$tele.'" required><br>
</td>
