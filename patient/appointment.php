...
<body>
    ...
    $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,appointment.complaints,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid ";
    ...
    <div class="container">
        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-doctor">
                        <a href="report.php" class="non-style-link-menu"><div><p class="menu-text">Medical Report</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <div class="h2-search">
                                                                Complaint: ' . $complaints . '<br> <!-- Display the complaint here -->
                                                            </div>
                                                                <div class="h3-search">
